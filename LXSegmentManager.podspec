#
#  Be sure to run `pod spec lint LXSegmentManager.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  LXSegmentManager is manager
                   DESC

  spec.homepage     = "https://github.com/LIXIANGXLee/LXSegmentManagerModule"
  ...
  spec.source       = { :git => "https://github.com/LIXIANGXLee/LXSegmentManagerModule.git", :tag => "#{spec.version}" }
